...
RUN_DIR=${PF_STAGE1_RUN_DIR:-${ROOT}/runs/stage1}
CONFIG=${PF_STAGE1_CONFIG:-${ROOT}/configs/training/stage1_cm_init.yaml}
NNODES=${PF_NNODES:-1}
NPROC_PER_NODE=${PF_NPROC_PER_NODE:-8}
export PF_BASE_CHECKPOINT=${PF_BASE_CHECKPOINT:-${ROOT}/checkpoints/base/causal_cd.pt}
